...
- ~~[Q-066-1](../../99-open-questions.md)~~ — **Closed 2026-07-30 (перемер на активном прогоне):** поток событий **одноразовый** — историю получает первый подписчик, повторная подписка не получает ни реплея, ни новых событий. Следствия: [Q-067-1](../../99-open-questions.md) закрыт отрицательно (adoption и ретрай подписки невозможны), [Q-067-5](../../99-open-questions.md) утратил предмет, заведён [Q-067-12](../../99-open-questions.md) (drain-режим деплоя).
...
- [Q-067-12](../../99-open-questions.md) — нужен ли drain-режим деплоя (рестарт `api` под активным прогоном необратимо теряет биллинговый хвост).
